...
apply_vertical_gate <- function(cls_type, v_l, v_h, tag_l, tag_h, x_val, y_val, cls_f, clone, sort_date, cls_color, xlab = "GFP", ylab = "tdTomato", xlim = c(-0.5, 12),
    ...
    if (0) {
        ...
        plot(x_val[cls_f], y_val[cls_f],
            pch = 19, cex = 0.5, ylab = ylab, xlab = xlab, col = cls_color[cls_f], main = paste(clone, sort_date, " chimera embryos", sep = " "),
            xlim = xlim, ylim = ylim
        )
    ...
    plot(x_val[cls_f], y_val[cls_f],
        pch = 19, cex = 0.5, ylab = ylab, xlab = xlab, col = gate_color, main = paste(clone, sort_date, " chimera embryos", sep = " "),
        xlim = xlim, ylim = ylim
    )
    abline(v = v_l, lty = "dashed")
    abline(v = v_h, lty = "dashed")
...
for (clone in c("TKO23", "TKO26", "TKO29")) {
    ...
    plot(gfp_tr[cls_f], tdtomato_tr[cls_f],
        pch = 19, cex = 0.5, ylab = "tdTomato", xlab = "GFP", col = cls_color[cls_f], main = paste(clone, " chimera embryos", sep = " "),
        xlim = xlim, ylim = ylim
    )
    ...
    for (sort_date in sort_dates) {
        ...
        plot(gfp_tr[cls_ff], tdtomato_tr[cls_ff],
            pch = 19, cex = 0.5, ylab = "tdTomato", xlab = "GFP", col = cls_color[cls_ff], main = paste(clone, sort_date, " chimera embryos", sep = " "),
            xlim = xlim, ylim = ylim
        )
        points(gfp_tr[ff], tdtomato_tr[ff], cex = 0.5, pch = 19, col = cls_color[ff])
        dev.off()
...
plot(fsc_a[cls_ff], tdtomato_tr[cls_ff],
    pch = 19, cex = 0.5, ylab = "tdTomtato", xlab = "FSC_A", col = cls_color[cls_ff], main = paste(clone, sort_date, " chimera embryos", sep = " "),
    ylim = ylim
)
...
plot(ssc_a[cls_ff], tdtomato_tr[cls_ff],
    pch = 19, cex = 0.5, ylab = "tdTomtato", xlab = "SSC_A", col = cls_color[cls_ff], main = paste(clone, sort_date, " chimera embryos", sep = " "),
    ylim = ylim
)
...
plot(ssc_a[cls_ff], fsc_a[cls_ff],
    pch = 19, cex = 0.5, ylab = "FSC-A", xlab = "SSC_A", col = cls_color[cls_ff],
...
cls_type <- apply_vertical_and_horizontal_gate(
    cls_type = cls_type,
...
cls_type <- apply_horizontal_gate(
    cls_type = cls_type,
    h_l = h_l, h_h = h_h,
    tag_l = "host",
    tag_h = "KO",
