...
dko13_gating = function(plot_pdf = F) {
...
plot(gfp_tr,fsc_a,pch = 19,cex = 0.5,xlab = "GFP",ylab = "FSC-A",col = cls_color,main = paste("All DKO13 chimera embryos",sep = " "),xlim = lim_gfp,ylim = lim_fsc)
points(gfp_tr[!f],fsc_a[!f],cex = 0.5,pch = 19,col = cls_color[!f])
dev.off()

png(sprintf("%s/gfp_vs_ssc_all.png",fig_dir))
plot(gfp_tr,ssc_a,pch = 19,cex = 0.5,xlab = "GFP",ylab = "SSC-A",col = cls_color,main = paste("All DKO13 chimera embryos",sep = " "),xlim = lim_gfp,ylim = lim_ssc)
...
plot(gfp_tr,fsc_a,pch = 19,cex = 0.5,xlab = "GFP",ylab = "FSC-A",col = gate_color,main = paste("All DKO13 chimera embryos",sep = " "),xlim = lim_gfp,ylim = lim_fsc)
abline(a = a_l,b = b_l,lty = "dashed")
abline(a = a_h,b = b_h,lty = "dashed")
legend(x = "topright",pch = 19,col = c("blue","coral3","gray70"),legend = c("Host","DKO13","unclear"))
dev.off()
