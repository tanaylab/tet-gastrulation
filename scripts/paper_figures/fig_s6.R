...
plot_heatmap_marker_genes_node_and_foregut_lineage = function() {
  ...
  genes_all = c("T","Aldh1a2","Cdx1","Cer1","Dand5;SP1","Dnaja4","Dnajb13","Dynlrb2","Fam183b","Foxa2","Foxj1;Rnf157","Fst","Gal",
  ...
  pheatmap::pheatmap(legc[genes_all,c(mc_node,mc_gut)],color = shades,cluster_cols = F,treeheight_row = 0,
