...
plot_host_vs_ko_rank = function(mat_nm) {
  ...
  plot(chim_emb_summary$best_rank_ko[f],chim_emb_summary$best_rank_host[f],pch = 19,xlim = c(rank_min,rank_max),ylim =  c(rank_min,rank_max),main = "KO vs host",
  ...
  plot(rank_to_time$developmental_time[chim_emb_summary$best_rank_ko[f]],
       rank_to_time$developmental_time[chim_emb_summary$best_rank_host[f]],pch = 19,
